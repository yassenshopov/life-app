...
export const EXERCISE_LIBRARY: ExerciseLibrary = {
  ...
  back_and_chest: [
    ...
    { name: 'Incline Dumbbell Press', primaryMuscle: 'upper_chest', secondaryMuscles: ['front_delts', 'triceps'] },
    ...
    { name: 'Barbell Row', primaryMuscle: 'lats', secondaryMuscles: ['rhomboids', 'biceps', 'rear_delts'] },
