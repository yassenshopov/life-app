            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <div className="bg-blue-50 dark:bg-blue-900/30 p-4 rounded-lg">
                  <h4 className="text-sm font-medium text-blue-700 dark:text-blue-300">Sleep</h4>
                ...
                <div className="bg-red-50 dark:bg-red-900/30 p-4 rounded-lg">
                  <h4 className="text-sm font-medium text-red-700 dark:text-red-300">RHR</h4>
                  <p className="text-2xl font-bold text-red-900 dark:text-red-100">
                    {entries[0]?.rhr ?? '-'} bpm
                  </p>
                </div>
                <div className="bg-green-50 dark:bg-green-900/30 p-4 rounded-lg">
                  <h4 className="text-sm font-medium text-green-700 dark:text-green-300">Steps</h4>
